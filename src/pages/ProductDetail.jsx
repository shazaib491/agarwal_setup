                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            <div class="product-images">
                                ...
                                <ul class="thumb-nav d-md-flex justify-content-center">
                                    <li className="w-100"><img className=" " src="../assets/img/shop/single-1.jpg" alt="product-thumb" /></li>
                                    <li className="w-100"><img className=" " src="../assets/img/shop/single-2.jpeg" alt="product-thumb" /></li>
                                    <li className="w-100"><img className=" " src="../assets/img/shop/single-3.jpeg" alt="product-thumb" /></li>
                                    <li className="w-100"><img className=" " src="../assets/img/shop/single-4.jpg" alt="product-thumb" /></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-12">
                            <div class="single-product">
                                ...
                                <div class="quantity mt-30">
                                    <form method="get"> <input type="number" name="quantity" min="1" max="9" step="1" value="1" /> <button type="submit" class="dark-pulse-button add-to-cart-button">Buy Now</button> </form>
                                </div>
                                <div class="product-categories">
                                    <div class="display-b">
                                        <span>Length: </span>
                                        <ul>
                                            <li><a href="#">{product.length}</a></li>
                                        </ul>
                                    </div>
                                    <div class="display-b">
                                        <span>Width: </span>
                            ...
                            <div class="shop-tabs">
                                <div class='tabs tabs_animate mt-70'>
                                    ...
                                    <div id='tab-2' class="clearfix product-tab-body">
                                        ...
                                        <ul>
                                            <li><span>Name:</span>{product.product}</li>
                                            <li><span>Length:</span>{product.length}</li>
                                            <li><span>Width:</span>{product.width}</li>
                                            <li><span>Thickness:</span>{product.thick}</li>
                                            <li><span>Grade:</span>{product.grade}</li>
                                            <li><span>Color:</span>{product.color}</li>
                                            <li><span>Price:</span>{product.priceone}</li>
                                        ...
                                        <div class="customer-review">
                                            <div class="row">
                                                <div class="col-md-1 pr-0 hidden-sm-down">
                                                    ...
                                                    <div class="customer-review-stars"> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star-half-o" aria-hidden="true"></i> </div>
                                                </div>
